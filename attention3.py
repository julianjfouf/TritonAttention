...
@triton.jit
def _causal_attention_kernel3_1(
...
@triton.jit
def _causal_attention_kernel3_2(
...
def causal_attention3(q, k, v):
    ...
    _causal_attention_kernel3_1[grid](
    ...
    _causal_attention_kernel3_2[grid](
        qk, qk.stride(0), qk.stride(1), qk.stride(2),
